...
class AutoNavigationArrows extends WP_Widget {
	...
	/**
	 * @param array $setupLinks
	 */
	public function setSetupLinks( $setupLinks ) {
		$pageIdsArray = array();

		// Take arguments set by @getArrayOfPages
		foreach ( $this->getArrayOfPages( $setupLinks ) as $page ) {
			$pageIdsArray[] += $page->ID;
		}
		$this->setupLinks = $pageIdsArray;
	}
